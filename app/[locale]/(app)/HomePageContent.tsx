		...
		<div className="welcome-page min-h-screen" style={{ backgroundColor: "var(--neutral-50)" }}>
				...
				<div className="welcome-hero-container">
					...
					<div className="welcome-hero-content">
						<h1 className="welcome-hero-title">
							{t("title.main")} {" "}
							<span className="welcome-gradient-text">{t("title.highlight")}</span>{" "}
							{t("title.suffix")}
						</h1>
					...
					<div className="welcome-animation-container">
						<Lottie animationData={welcomeAnimation} loop autoplay style={{ width: "100%", height: "100%" }} />
					</div>
				</div>
			</section>
			...
			<section id="features" className="welcome-features">
				<div className="welcome-features-container">
					<div className="welcome-section-header">
						...
						<h2 className="welcome-section-title">{t("features.title")}</h2>
						<p className="welcome-section-subtitle">{t("features.subtitle")}</p>
					</div>
			...
			<section className="welcome-cta">
				<div className="welcome-cta-container">
					<h2 className="welcome-cta-title">{t("cta.title")}</h2>
					<p className="welcome-cta-subtitle">{t("cta.subtitle")}</p>
					<div className="welcome-cta-buttons">
						...
						<Link
							href={`/${locale}/faq`}
							className="welcome-btn welcome-btn-secondary welcome-btn-large"
