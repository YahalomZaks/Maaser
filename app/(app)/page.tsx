			...
			<nav className="welcome-navbar">
				<div className="welcome-nav-container">
					...
					<div className="welcome-nav-links">
						...
						<Link href="/signin" className="welcome-btn welcome-btn-secondary">התחבר</Link>
						<Link href="/signup" className="welcome-btn welcome-btn-primary">הירשם בחינם</Link>
					</div>
				</div>
			</nav>
				...
				<div className="welcome-hero-container">
					...
					>
						...
						<div className="welcome-hero-buttons">
							<Link href="/signin" className="welcome-btn welcome-btn-primary welcome-btn-large">
							...
							<div className="welcome-donation-flow">
								{[1, 2, 3].map((step, index) => (
									<div key={step} className={`welcome-donation-step welcome-step-${step}`}>
										<div 
											ref={el => {
												if (el) stepIconsRef.current[index] = el;
											}}
							...
							<div>
								{[
									...
									<div 
										key={index}
										ref={el => {
											if (el) transactionItemsRef.current[index] = el;
										}}
			...
			<section className="welcome-cta">
				<div className="welcome-cta-container">
					...
					<div className="welcome-cta-buttons">
						<Link href="/signup" className="welcome-btn welcome-btn-white welcome-btn-large">
							<Rocket className="h-5 w-5" style={{ marginRight: '0.5rem' }} />
							{t('cta.buttons.start')}
						</Link>
