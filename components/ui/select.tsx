...
function useSelectDirection(explicit?: Direction) {
  const locale = useLocale()
  const inferred: Direction = locale?.toLowerCase().startsWith("he") ? "rtl" : "ltr"
...
function Select({
  ...
  const direction = useSelectDirection(dir as Direction | undefined)
...
function SelectContent({
  ...
  const direction = useSelectDirection(dir as Direction | undefined)
  const resolvedAlign = align ?? (direction === "rtl" ? "end" : "start")
  return (
